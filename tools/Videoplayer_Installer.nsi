...
; The file to write
OutFile "Plugin_Videoplayer_${VERSION}.exe"
...
; Sections
Section "Videoplayer" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\Videoplayer"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\Videoplayer\Plugin_Videoplayer.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\Videoplayer\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\Videoplayer"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\Videoplayer\Plugin_Videoplayer.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\Videoplayer\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_Videoplayer"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_Videoplayer\inc"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_Videoplayer\changelog.md"'
FunctionEnd
